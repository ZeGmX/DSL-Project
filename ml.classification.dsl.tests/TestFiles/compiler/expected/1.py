...
classifier.read("../../../ProjetGit/DSL-Project/data-individuals-very-tiny.txt", ";")
classifier.add_columns([1, 2, 3])
column_to_predict = 1
classifier.predict_column = column_to_predict
classifier.strategy = "train_test"
classifier.train_test_ratio = 0.7
