...
x9 <- 9
ratio <- 0.5
classifier$add_columns(list(null, null))
classifier$remove_columns(list(null, null, null))
classifier$remove_columns(list(null))
classifier$setPredict_column(x4)
classifier$setAlgo("tree")
classifier$setMetric("f1")
classifier$setStrategy("train_test")
classifier$setTrain_test_ratio(null)
