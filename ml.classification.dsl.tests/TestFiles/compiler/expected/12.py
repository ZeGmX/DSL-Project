...
x9 = 9
ratio = 0.5
classifier.add_columns([x1, x2])
classifier.remove_columns([x3, x4, x5])
classifier.remove_columns([x9])
classifier.predict_column = x4
classifier.algo = "tree"
classifier.metric = "f1"
classifier.strategy = "train_test"
classifier.train_test_ratio = ratio
classifier.predict()
